...
def publish_message_status():
    msgs = [{'topic': "cmnd/sonoff/status", 'payload': "10"}]
    publish.multiple(msgs, hostname='m12.cloudmqtt.com', port=10820, keepalive=60,
                     auth={'username': "mlawbgod", 'password': "xaGpbI5L7gQX"})
